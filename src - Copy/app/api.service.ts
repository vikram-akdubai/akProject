...
// Doctor Profile api
  ...
  public postDoctorprof(usertitle:any,userfname:any,userlname:any,usergender:any,userlang:any,userspeciality:any,usercountrycode:any,usermobile:any,useremailid:any,userdob:any,userwebsite:any,usercliniclist:any,aboutmeedit:any): Observable<any> 
      {
        console.log(httpOptions);  
        let params = new HttpParams(); 
        params = params.append('title', usertitle);
        params = params.append('user_type', "2");
        params = params.append('user_id', "DRVIKRAMGEHLOT19882020");
        params = params.append('first_name', userfname);
        params = params.append('last_name', userlname);
        params = params.append('gender', usergender);
        params = params.append('select_language', userlang);
        params = params.append('country_code', usercountrycode);
        params = params.append('mobile_number', usermobile);
        params = params.append('email_id', useremailid);
        params = params.append('date_of_birth', userdob);
        params = params.append('website', userwebsite);
        params = params.append('speciality', userspeciality);
        params = params.append('practicing_in', usercliniclist);
        params = params.append('about_me', aboutmeedit);
  ...
  public getDoctorProfile(user_id:any){
          ...
          params = params.append('method', "get_image_data");
              return this.httpClient.post(`https://artelir.com:3018/doctor/professional_details`, params, httpOptions).map((res: HttpResponse<JSON>) => res);  
        }
  ...
  public PostDrReg(title:any,firstName:any,lastName:any,email:any,countrycode:any,mobile:any,dob:any,password:any): Observable<any> 
      {
        ...
        return this.httpClient.post(`https://artelir.com:3018/patient/registration`, params, httpOptions).map((res: HttpResponse<JSON>) => res);
       }
